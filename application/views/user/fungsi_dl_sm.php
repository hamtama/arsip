<script text="text/javascript">
    ...
    $('.tolak').click(function() {
        ...
        $('#mode').val("update");
        $('#id').val(id);
        $("#form_bobot").attr("action", "<?= base_url($menu['url'] . '/reject_dl_sm'); ?>");
        $('#myLargeModalLabel').text('Tolak Surat Masuk');
    ...
    $('.editBtn').click(function() {
        ...
        $('#mode').val("update");
        $('#id').val(id);
        $("#form_bobot").attr("action", "<?= base_url($menu['url'] . '/add_dl_sm'); ?>");
    ...
    $('#Medium-modal').on('hidden.bs.modal', function() {
        var a = $('#nos').val();
        $('#no_surat,#keterangan,#instruksi').removeClass('is-valid');
        $('#no_surat,#keterangan,#instruksi').removeClass('is-invalid');
        $('#no_surat,#instruksi').val(a);
        $('#keterangan').text('');
    });
</script>